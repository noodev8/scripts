"""ARIZONA-BLUE size-availability — the in-season core-size view.
...
See ARIZONA-BLUE.md. To clone for another brick, copy the folder and change SEG.

Run:  python scale/arizona-blue/size_availability.py
"""
import sys, os

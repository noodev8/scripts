"""ARIZONA-BROWN size-availability — the in-season core-size view.
...
See ARIZONA-BROWN.md. To clone for another brick, copy the folder and change SEG.

Run:  python scale/arizona-brown/size_availability.py
"""
import sys, os

"""ARIZONA-WHITE size-availability — the in-season core-size view.
...
See ARIZONA-WHITE.md. To clone for another brick, copy the folder and change SEG.

Run:  python scale/arizona-white/size_availability.py
"""
import sys, os

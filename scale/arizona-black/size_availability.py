"""ARIZONA-BLACK size-availability — the in-season core-size view.
...
See ARIZONA-BLACK.md. To clone for another brick, copy the folder and change SEG.

Run:  python scale/arizona-black/size_availability.py
"""
import sys, os

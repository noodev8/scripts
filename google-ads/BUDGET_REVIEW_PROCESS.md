...
## Current State — updated 7 June 2026
...
- **Active cap: £120/day, STANDARD only.** tROAS **400%**, held since Feb.
- **Last change — 6 Jun, £110 → £120 (steady ladder, user-set):** raised one £10 notch the evening of 6 Jun. The intent is explicitly a **steady, incremental climb rather than another big jump to £180** — the £140/£180 flops proved a hard leap at 400% tROAS just buys junk headroom. £110 had held since 4 Jun (which validated the £100 band at ~19x). **Judge on marginal ROAS within 24–48h, not imp share** (the imp-share gap is exactly what suckered the £140 raise). Kill signal = the 3-Jun signature: Google front-loading over cap *and* conversions collapsing. If the extra ~£10 converts like the core (8x+), let it ride and consider another small step.
...
| Date | Move | Why |
|------|------|-----|
| 2026-06-06 | STANDARD £110 → £120 (tROAS 400%) — **steady ladder, user-set** | Raised one £10 notch the evening of 6 Jun. Deliberate incremental climb rather than another big jump to £180 — the £140/£180 flops proved a hard leap at 400% tROAS only buys junk headroom. £110 had held since 4 Jun. Judge on marginal ROAS in 24–48h, not imp share. Kill on the 3-Jun signature (over-cap front-load + conversions collapsing). |

...
## Current State — updated 25 June 2026
...
- **Active settings: £260/day cap (a ceiling, deliberately non-binding) + tROAS 600%.** Budget raised £240→£260 25 Jun — **effective 25 Jun.** Budget path: £180→£200 (21 Jun) → £220 (23 Jun) → £240 (24 Jun) → £260 (25 Jun). tROAS path: 400→500 (8 Jun) → 600 (10 Jun) → 550 (13 Jun) → 600 (17 Jun). Per-move detail is in Recent changes below.
- **Posture: riding the heatwave, budget stepped up to match continued peak demand.** The 13–17 Jun 550 volume lean is **closed** — it caught the hot days (14 Jun £246/7.5x, 16 Jun £226/8.4x) but ran spend onto the soft ones (15 Jun £170/£729 4.3x, 17 Jun ~£156/£698 4.5x). Back at the proven 600 floor: it refuses sub-6x soft-day junk and **doesn't cost the hot days** (11 Jun ran 600 → 15.2x/£1,573; 20 Jun → 10.3x/£2,179; 21 Jun → 11.6x/£2,745). Budget raised to £260 — smoothing ceiling now ~£520 — continuing to ride the heatwave pool. Normal days self-spend £125–150 regardless; the raise is a hot-day catch. The live lever is tROAS.
- **Bias now (point-in-time):** hold 600, ride budget signal-by-signal into the heatwave. **Full settled at 50/135 (37%) on 24 Jun** — down from 56/132 (42%) post-delivery peak; range widened by 3 styles. The delivery boost is behind us; Full settling is expected. Weekend 20–21 Jun: £4,924 total vs £3,260 prior weekend (+51%), both days over cap at 10–12x — ROAS accelerating, not diluting. No fixed re-learn window. **The 11–13 Jun `lost_is_rank` spike (8.3/4.7/5.1%) is resolved — NOT a competitive flag.** It was a tROAS-600 floor artefact: lost-to-budget collapsed to ~0 as lost-to-rank rose (the composition-flip tell), and the price-benchmark scan showed us *below* market on ~94% of clicked traffic. Self-inflicted by the tight floor, not a rival or a price slip — see the tripwire section. **Kill pattern (any cap):** the 3-Jun signature — over-cap front-load *and* CVR halving toward ~4% by mid-afternoon → cut cap the same day. A merely lower ROAS (7–8x) with sane pacing is **not** a kill.
...
| Date | Move | Why |
|------|------|-----|
| 2026-06-25 | STANDARD budget £240 → £260 (tROAS held 600%) — **effective 25 Jun** | Continuing heatwave. Stepping budget up signal-by-signal; smoothing ceiling moves to ~£520. Soft days self-spend £125–150 regardless; raise targets the over-cap hot days only. tROAS held 600 — proven not to cost the peak days. |
| 2026-06-24 | STANDARD budget £220 → £240 (tROAS held 600%) — **effective 24 Jun** | Continuing heatwave peak. Full at 50/135 (37%) — delivery-boosted breadth settling but not retreating. Budget raised to extend the hot-day catch; smoothing ceiling moves to ~£480. Soft days remain self-capped at £125–150; the raise targets the over-cap demand days only. tROAS held at 600 — proven not to cost the hot days. |

...
## Current State — updated 3 June 2026
...
- **Last change — 3 Jun, £140 → £100 (same-day revert of the 2 Jun raise):** £140 failed fast. Set late on 2 Jun; spend surged then stalled, and by mid-3 Jun Google had front-loaded **£158 (over the £140 cap)** with barely any conversions — negative marginal ROAS on the increment. Same shape as the 29 May £180 flop (£204 for +1 click). The "unserved demand" the raise chased — imp share 52% at £100 on 30 May — turned out to be **junk, not convertible**: £140 bought the extra impressions/clicks and they didn't convert. The auction wall has dropped *below* the old £165 line, consistent with thinning early-June demand (heat gone, school back — same unwind as late May). Reverted to the proven £100 band (30 May–1 Jun ran healthy ROAS at £91–£120).
- **The £180 failure was an auction wall (re-diagnosed 2 Jun):** at 96% imp share the £45 increment bought ~3k extra impressions for **+1 click** — junk inventory Google scraped to spend the cap (we never even got the clicks). The real ceiling is the *convertible-demand pool*; ~£165 at this tROAS in late May, now apparently **lower (~£100–120)** as June demand thins — above it, budget buys impressions, not clicks. **Treat anything above the proven £100 band as junk-line risk until ROAS data says otherwise.**
- **Bias now (point-in-time, not a plan):** Hold £100 — it's the proven band and the convertible pool looks to have thinned to roughly here. Don't re-test a budget raise off an imp-share gap alone; the £140 revert just proved that gap is junk inventory, not demand. The next move worth considering is **tROAS, not budget**: a budget cap forces spend down the quality curve (exactly what £158-for-no-sales was), whereas tROAS refuses junk auctions automatically — it's the lever built for a thinning market. Not a same-day move (we just changed budget; one lever at a time, 5–7 day re-learn). If £100 holds 10x+ for a few days, that's the window to test lowering tROAS toward 300% only if imp share is short *and* spend sits below cap.
- **Open flags:**

...
- **Active cap: £180/day (a ceiling, deliberately non-binding), STANDARD only** (set for 11 Jun). tROAS **550%** — set EOD 13 Jun, **effective 14 Jun** (13 Jun still ran under 600; the `550` stamp on the 13 Jun row is change-time drift). Fourth tROAS move: 400→500 on 8 Jun, 500→600 on 10 Jun, 600→550 EOD 13 Jun. This is the **first deliberate volume lean** — a chosen trade, not a throttle response (see below).

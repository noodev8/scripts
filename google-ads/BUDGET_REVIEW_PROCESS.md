...
## Current State — updated 13 June 2026
...
- **Active cap: £180/day (a ceiling, deliberately non-binding), STANDARD only** (set for 11 Jun). tROAS **550%** — eased from 600% on 13 Jun (fourth tROAS move: 400→500 on 8 Jun, 500→600 on 10 Jun, 600→550 on 13 Jun). This is the **first deliberate volume lean** — a chosen trade, not a throttle response (see below).
